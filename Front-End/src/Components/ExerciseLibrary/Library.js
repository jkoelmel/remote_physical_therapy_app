            ...
            <List component="nav" aria-label="video-list">
                <ListSubheader color="inherit" className={classes.sticky}>
                    ...
                    <TextField
                        ...
                        color="secondary"
                        onChange={(e) => {
                            props.filterExercises(props.exercises, e.target.value)
                        }}
                        InputLabelProps={{
                            classes: {
                    ...
                    />
                    <Button aria-describedby="transition-modal-exercise" variant="contained" color="inherit"
                ...
                {props.exercises.map((ev, k) => (
                    <React.Fragment key={k}>
                        ...
                        <ListItem>
                            ...
                            <img className={classes.thumbnail} src={ev.thumbnail} alt={"YouTube Thumbnail"}/>
                        ...
                        <Grid container className={classes.gridUpload} direction="column" spacing={2}>
                            ...
                            <Grid item>
                                <TextField
                                    ...
                                    color="secondary"
                                    onChange={(e) => {
                                        setExercise_url(e.target.value)
                                    }}
                                    InputLabelProps={{
                                        classes: {
                                            root: classes.cssLabel,
                            ...
                            <Grid item>
                                <Button variant="outlined" color="secondary"
                                        onClick={HandleUploadSubmit}> Submit </Button>
                            </Grid>
                        </Grid>
                    </Paper>
