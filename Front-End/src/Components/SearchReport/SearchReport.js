            ...
            >
                {patientReport.map((pr) => (
                    <div>
                        ...
                        <ListItemText className={classes.comments}
                                      primary={pr.comment === undefined ? '' : `Comment: ${pr.comment}`}/>
                        <Divider/>
                    </div>
                ...
                <Fade in={open}>
                    <Paper className={classes.paperUpload}>
                        <Grid container className={classes.gridUpload} direction="column" spacing={2}>
                            <Grid item>
                                <Typography variant='h5'> Write {props.selectedPatient.f_name} a comment on their
                                    progress:</Typography>
                            </Grid>
                            <Grid item>
                                <TextField
